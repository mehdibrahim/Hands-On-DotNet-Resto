...
namespace RestoManagerMehdi.Controllers
{
    public class AvisController : Controller
    {
        ...
        {
            ViewData["NumResto"] = new SelectList(_context.Restaurants, "CodeResto", "Specialite");
            return View();
        }
        ...
        //    if (ModelState.IsValid)
            ...
            ViewData["NumResto"] = new SelectList(_context.Restaurants, "CodeResto", "Specialite", avis.NumResto);
            return View(avis);
        }
